...
class ProductsPage(BasePage):
    ...
    def add_element_to_cart(self):
        WebDriverWait(self.driver, 2).until(EC.element_to_be_clickable(self.product_container_selector))
    ...
    def proceed_to_checkout(self):
        WebDriverWait(self.driver, 11).until(EC.element_to_be_clickable(self.shopping_cart_selector)).click()
